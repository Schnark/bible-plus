...
var BOOKS = {
	...
	ot: [
		...
		{id: 'prov', title: 'Proverbs', z: 20, chapters: [
			33, 22, 35, 27, 23, 35, 27, 36, 18, 32, 31, 28, 25, 35, 33,
			33, 28, 24, 29, 30, 31, 29, 35, 34, 28, 28, 27, 28, 27, 33,
			31
		]},
		{id: 'eccl', title: 'Ecclesiastes', z: 21, chapters: [
			18, 26, 22, 16, 20, 12, 29, 17, 18, 20, 10, 14
		]},
		{id: 'song', title: 'Song of Solomon', z: 22, chapters: [17, 17, 11, 16, 16, 13, 13, 14]},
		{id: 'isa', title: 'Isaiah', z: 23, chapters: [
		...
		{id: 'lam', title: 'Lamentations', z: 25, chapters: [22, 22, 66, 22, 22]},
		{id: 'ezek', title: 'Ezekiel', z: 26, chapters: [
		...
		{id: 'amos', title: 'Amos', z: 30, chapters: [15, 16, 15, 13, 27, 14, 17, 14, 15]},
		{id: 'obad', title: 'Obadiah', z: 31, chapters: [21]},
		{id: 'jonah', title: 'Jonah', z: 32, chapters: [17, 10, 10, 11]},
		{id: 'mic', title: 'Micah', z: 33, chapters: [16, 13, 12, 13, 15, 16, 20]},
		{id: 'nah', title: 'Nahum', z: 34, chapters: [15, 13, 19]},
		{id: 'hab', title: 'Habakkuk', z: 35, chapters: [17, 20, 19]},
		{id: 'zeph', title: 'Zephaniah', z: 36, chapters: [18, 15, 20]},
		{id: 'hag', title: 'Haggai', z: 37, chapters: [15, 23]},
		{id: 'zech', title: 'Zechariah', z: 38, chapters: [
	...
	nt: [
		...
		{id: 'matt', title: 'Matthew', z: 40, chapters: [
			25, 23, 17, 25, 48, 34, 29, 34, 38, 42, 30, 50, 58, 36, 39,
			28, 27, 35, 30, 34, 46, 46, 39, 51, 46, 75, 66, 20
		]},
		{id: 'mark', title: 'Mark', z: 41, chapters: [
			45, 28, 35, 41, 43, 56, 37, 38, 50, 52, 33, 44, 37, 72, 47,
			20
		]},
		{id: 'luke', title: 'Luke', z: 42, chapters: [
			80, 52, 38, 44, 39, 49, 50, 56, 62, 42, 54, 59, 35, 35, 32,
			31, 37, 43, 48, 47, 38, 71, 56, 53
		]},
		{id: 'john', title: 'John', z: 43, chapters: [
			51, 25, 36, 54, 47, 71, 53, 59, 41, 42, 57, 50, 38, 31, 27,
			33, 26, 40, 42, 31, 25
		]},
		{id: 'acts', title: 'Acts of the Apostles', z: 44, chapters: [
			26, 47, 26, 37, 42, 15, 60, 40, 43, 48, 30, 25, 52, 28, 41,
			40, 34, 28, 41, 38, 40, 30, 35, 27, 27, 32, 44, 31
		]},
		{id: 'rom', z: 45, chapters: [
			32, 29, 31, 25, 21, 23, 25, 39, 33, 21, 36, 21, 14, 23, 33,
			27
		]},
		{id: '1cor', z: 46, chapters: [
			31, 16, 23, 21, 13, 20, 40, 13, 27, 33, 34, 31, 13, 40, 58,
			24
		]},
		{id: '2cor', z: 47, chapters: [
			24, 17, 18, 18, 21, 18, 16, 24, 15, 18, 33, 21, 14
		]},
		{id: 'gal', z: 48, chapters: [24, 21, 29, 31, 26, 18]},
		{id: 'eph', z: 49, chapters: [23, 22, 21, 32, 33, 24]},
		{id: 'phil', z: 50, chapters: [30, 30, 21, 23]},
		{id: 'col', z: 51, chapters: [29, 23, 25, 18]},
		{id: '1thess', z: 52, chapters: [10, 20, 13, 18, 28]},
		{id: '2thess', z: 53, chapters: [12, 17, 18]},
		{id: '1tim', z: 54, chapters: [20, 15, 16, 16, 25, 21]},
		{id: '2tim', z: 55, chapters: [18, 26, 17, 22]},
		{id: 'titus', z: 56, chapters: [16, 15, 15]},
		{id: 'phlm', z: 57, chapters: [25]},
		{id: 'heb', z: 58, chapters: [
			14, 18, 19, 16, 14, 20, 28, 13, 28, 39, 40, 29, 25
		]},
		{id: 'jas', z: 59, chapters: [27, 26, 18, 17, 20]},
		{id: '1pet', z: 60, chapters: [25, 25, 22, 19, 14]},
		{id: '2pet', z: 61, chapters: [21, 22, 18]},
		{id: '1john', z: 62, chapters: [10, 29, 24, 21, 21]},
		{id: '2john', z: 63, chapters: [13]},
		{id: '3john', z: 64, chapters: [14]},
		{id: 'jude', z: 65, chapters: [25]},
		{id: 'rev', title: 'Revelation to John', z: 66, chapters: [
