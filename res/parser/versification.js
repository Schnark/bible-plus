...
var VERSIFICATION_SCHEMES = {};
VERSIFICATION_SCHEMES.KJV = {
	ot: [
		{id: 'ot', chapters: [0]},
		{id: 'gen', chapters: [
		...
		{id: 'ezra', chapters: [11, 70, 13, 24, 17, 22, 28, 36, 15, 44]},
		{id: 'neh', chapters: [
			11, 20, 32, 23, 19, 19, 73, 18, 38, 39, 36, 47, 31
		]},
		{id: 'esth', chapters: [22, 23, 15, 17, 14, 14, 10, 17, 32, 3]},
		{id: 'job', chapters: [
		...
		{id: 'song', chapters: [17, 17, 11, 16, 16, 13, 13, 14]},
		{id: 'isa', chapters: [
		...
		{id: 'lam', chapters: [22, 22, 66, 22, 22]},
		{id: 'ezek', chapters: [
		...
		{id: 'joel', chapters: [20, 32, 21]},
		{id: 'amos',  chapters: [15, 16, 15, 13, 27, 14, 17, 14, 15]},
		{id: 'obad', chapters: [21]},
		{id: 'jonah', chapters: [17, 10, 10, 11]},
		{id: 'mic', chapters: [16, 13, 12, 13, 15, 16, 20]},
		{id: 'nah', chapters: [15, 13, 19]},
		{id: 'hab', chapters: [17, 20, 19]},
		{id: 'zeph', chapters: [18, 15, 20]},
		{id: 'hag', chapters: [15, 23]},
		{id: 'zech', chapters: [
			21, 13, 10, 14, 11, 15, 14, 23, 17, 12, 17, 14, 9, 21
		]},
		{id: 'mal', chapters: [14, 17, 18, 6]}
	],
	nt: [
		{id: 'nt', chapters: [0]},
		{id: 'matt',  chapters: [
		...
		{id: 'gal', chapters: [24, 21, 29, 31, 26, 18]},
		{id: 'eph',  chapters: [23, 22, 21, 32, 33, 24]},
		{id: 'phil', chapters: [30, 30, 21, 23]},
		{id: 'col', chapters: [29, 23, 25, 18]},
		{id: '1thess', chapters: [10, 20, 13, 18, 28]},
		{id: '2thess', chapters: [12, 17, 18]},
		{id: '1tim', chapters: [20, 15, 16, 16, 25, 21]},
		{id: '2tim', chapters: [18, 26, 17, 22]},
		{id: 'titus', chapters: [16, 15, 15]},
		{id: 'phlm', chapters: [25]},
		{id: 'heb', chapters: [
			14, 18, 19, 16, 14, 20, 28, 13, 28, 39, 40, 29, 25
		]},
		{id: 'jas', chapters: [27, 26, 18, 17, 20]},
		{id: '1pet', chapters: [25, 25, 22, 19, 14]},
		{id: '2pet', chapters: [21, 22, 18]},
		{id: '1john', chapters: [10, 29, 24, 21, 21]},
		{id: '2john', chapters: [13]},
		{id: '3john', chapters: [14]},
		{id: 'jude', chapters: [25]},
		{id: 'rev', chapters: [
...
VERSIFICATION_SCHEMES.German = {
	ot: [
		...
		{id: '1sam', chapters: [
			28, 36, 21, 22, 12, 21, 17, 22, 27, 27, 15, 25, 23, 52, 35,
			23, 58, 30, 24, 42, 16, 23, 28, 23, 44, 25, 12, 25, 11, 31,
			13
		]},
		{id: '2sam', chapters: [
			27, 32, 39, 12, 25, 23, 29, 18, 13, 19, 27, 31, 39, 33, 37,
		...
		{id: '2kgs', chapters: [
			18, 25, 27, 44, 27, 33, 20, 29, 37, 36, 20, 22, 25, 29, 39,
			20, 41, 37, 37, 21, 26, 20, 37, 20, 30
		]},
		{id: '1chr', chapters: [
		...
		{id: 'ps', chapters: [
			6, 12, 9, 9, 13, 11, 18, 10, 21, 18, 7, 9, 6, 7, 5, 11, 15,
			51, 15, 10, 14, 32, 6, 10, 22, 12, 14, 9, 11, 13, 25, 11, 22,
			23, 28, 13, 40, 23, 14, 18, 14, 12, 5, 27, 18, 12, 10, 15, 21,
			23, 21, 11, 7, 9, 24, 14, 12, 12, 18, 14, 9, 13, 12, 11, 14, 20,
			8, 36, 37, 6, 24, 20, 28, 23, 11, 13, 21, 72, 13, 20, 17, 8, 19,
			13, 14, 17, 7, 19, 53, 17, 16, 16, 5, 23, 11, 13, 12, 9, 9, 5, 8,
			29, 22, 35, 45, 48, 43, 14, 31, 7, 10, 10, 9, 8, 18, 19, 2, 29,
			176, 7, 8, 9, 4, 8, 5, 6, 5, 6, 8, 8, 3, 18, 3, 3, 21, 26, 9, 8,
		...
		{id: 'song', chapters: [17, 17, 11, 16, 16, 12, 14, 14]},
		{id: 'isa', chapters: [
		...
		{id: 'joel', chapters: [20, 27, 5, 21]},
		{id: 'amos', chapters: [15, 16, 15, 13, 27, 14, 17, 14, 15]},
		{id: 'obad', chapters: [21]},
		{id: 'jonah', chapters: [16, 11, 10, 11]},
		{id: 'mic', chapters: [16, 13, 12, 14, 14, 16, 20]},
		{id: 'nah', chapters: [14, 14, 19]},
		{id: 'hab', chapters: [17, 20, 19]},
		{id: 'zeph', chapters: [18, 15, 20]},
		{id: 'hag', chapters: [15, 23]},
		{id: 'zech', chapters: [
		...
		{id: 'mal', chapters: [14, 17, 24]}
	],
	nt: VERSIFICATION_SCHEMES.KJV.nt
};

VERSIFICATION_SCHEMES.Vulg = {
	ot: [
		{id: 'ot', chapters: [0]},
		{id: 'gen', chapters: [
			31, 25, 24, 26, 31, 22, 24, 22, 29, 32, 32, 20, 18, 24, 21,
			16, 27, 33, 38, 18, 34, 24, 20, 67, 34, 35, 46, 22, 35, 43,
			55, 32, 20, 31, 29, 43, 36, 30, 23, 23, 57, 38, 34, 34, 28,
			34, 31, 22, 32, 25
		]},
		...
		{id: 'lev', chapters: [
			17, 16, 17, 35, 19, 30, 38, 36, 24, 20, 47, 8, 59, 57, 33,
			34, 16, 30, 37, 27, 24, 33, 44, 23, 55, 45, 34
		]},
		{id: 'num', chapters: [
			54, 34, 51, 49, 31, 27, 89, 26, 23, 36, 34, 15, 34, 45, 41,
			50, 13, 32, 22, 30, 35, 41, 30, 25, 18, 65, 23, 31, 39, 17,
			54, 42, 56, 29, 34, 13
		]},
		{id: 'deut', chapters: [
			46, 37, 29, 49, 33, 25, 26, 20, 29, 22, 32, 32, 18, 29, 23,
		...
		{id: 'josh', chapters: [
			18, 24, 17, 25, 16, 27, 26, 35, 27, 43, 23, 24, 33, 15, 63,
			10, 18, 28, 51, 9, 43, 34, 16, 33
		]},
		{id: 'judg', chapters: [
			36, 23, 31, 24, 32, 40, 25, 35, 57, 18, 40, 15, 25, 20, 20,
			31, 13, 31, 30, 48, 24
		]},
		{id: 'ruth', chapters: [22, 23, 18, 22]},
		{id: '1sam', chapters: [
			28, 36, 21, 22, 12, 21, 17, 22, 27, 27, 15, 25, 23, 52, 35,
			23, 58, 30, 24, 43, 15, 23, 28, 23, 44, 25, 12, 25, 11, 31,
			13
		]},
		{id: '2sam', chapters: [
			27, 32, 39, 12, 25, 23, 29, 18, 13, 19, 27, 31, 39, 33, 37,
		...
		{id: '1chr', chapters: [
			54, 55, 24, 43, 26, 81, 40, 40, 44, 14, 46, 40, 14, 17, 29,
			43, 27, 17, 19, 7, 30, 19, 32, 31, 31, 32, 34, 21, 30
		]},
		{id: '2chr', chapters: [
			17, 18, 17, 22, 14, 42, 22, 18, 31, 19, 23, 16, 22, 15, 19,
			14, 19, 34, 11, 37, 20, 12, 21, 27, 28, 23, 9, 27, 36, 27,
		...
		{id: 'jdt', chapters: [
			12, 18, 15, 17, 29, 21, 25, 34, 19, 20, 21, 20, 31, 18, 15,
			31
		]},
		{id: 'esth', chapters: [
		...
		{id: 'job', chapters: [
			22, 13, 26, 21, 27, 30, 21, 22, 35, 22, 20, 25, 28, 22, 35, 23,
			16, 21, 29, 29, 34, 30, 17, 25, 6, 14, 23, 28, 25, 31, 40, 22,
			33, 37, 16, 33, 24, 41, 35, 28, 25, 16
		]},
		{id: 'ps', chapters: [
			...
			9, 24, 13, 12, 12, 18, 14, 9, 13, 12, 11, 14, 20, 8, 36, 37, 6, 24,
			20, 28, 23, 11, 13, 21, 72, 13, 20, 17, 8, 19, 13, 14, 17, 7, 19,
			53, 17, 16, 16, 5, 23, 11, 13, 12, 9, 9, 5, 8, 29, 22, 35, 45, 48,
			43, 14, 31, 7, 10, 10, 9, 26, 9, 10, 2, 29, 176, 7, 8, 9, 4, 8, 5,
			7, 5, 6, 8, 8, 3, 18, 3, 3, 21, 27, 9, 8, 24, 14, 10, 8, 12, 15, 21,
			10, 11, 9, 14, 9, 6
		]},
		{id: 'prov', chapters: [
		...
		{id: 'song', chapters: [16, 17, 11, 16, 17, 12, 13, 14]},
		{id: 'wis', chapters: [
			16, 25, 19, 20, 24, 27, 30, 21, 19, 21, 27, 27, 19, 31, 19, 29,
			20, 25, 20
		]},
		{id: 'sir', chapters: [
			40, 23, 34, 36, 18, 37, 40, 22, 25, 34, 36, 19, 32, 27, 22, 31,
			31, 33, 28, 33, 31, 33, 38, 47, 36, 28, 33, 30, 35, 27, 42, 28,
			33, 31, 26, 28, 34, 39, 41, 32, 28, 26, 37, 27, 31, 23, 31, 28,
			19, 31, 38
		]},
		{id: 'isa', chapters: [
			31, 22, 26, 6, 30, 13, 25, 22, 21, 34, 16, 6, 22, 32, 9,
			14, 14, 7, 25, 6, 17, 25, 18, 23, 12, 21, 13, 29, 24, 33,
			9, 20, 24, 17, 10, 22, 38, 22, 8, 31, 29, 25, 28, 28, 26,
			13, 15, 22, 26, 11, 23, 15, 12, 17, 13, 12, 21, 14, 21, 22,
			11, 12, 19, 12, 25, 24
		]},
		{id: 'jer', chapters: [
			19, 37, 25, 31, 31, 30, 34, 22, 26, 25, 23, 17, 27, 22, 21,
			21, 27, 23, 15, 18, 14, 30, 40, 10, 38, 24, 22, 17, 32, 24,
			40, 44, 26, 22, 19, 32, 20, 28, 18, 16, 18, 22, 13, 30, 5,
			28, 7, 47, 39, 46, 64, 34
		]},
		{id: 'lam', chapters: [22, 22, 66, 22, 22]},
		{id: 'bar', chapters: [22, 35, 38, 37, 9, 72]},
		{id: 'ezek', chapters: [
			28, 9, 27, 17, 17, 14, 27, 18, 11, 22, 25, 28, 23, 23, 8,
			63, 24, 32, 14, 49, 32, 31, 49, 27, 17, 21, 36, 26, 21, 26,
			18, 32, 33, 31, 15, 38, 28, 23, 29, 49, 26, 20, 27, 31, 25,
			24, 23, 35
		]},
		...
		{id: 'joel', chapters: [20, 32, 21]},
		{id: 'amos', chapters: [15, 16, 15, 13, 27, 15, 17, 14, 15]},
		{id: 'obad', chapters: [21]},
		{id: 'jonah', chapters: [16, 11, 10, 11]},
		{id: 'mic', chapters: [16, 13, 12, 13, 14, 16, 20]},
		{id: 'nah', chapters: [15, 13, 19]},
		{id: 'hab', chapters: [17, 20, 19]},
		{id: 'zeph', chapters: [18, 15, 20]},
		{id: 'hag', chapters: [14, 24]},
		{id: 'zech', chapters: [
			21, 13, 10, 14, 11, 15, 14, 23, 17, 12, 17, 14, 9, 21
		]},
		{id: 'mal', chapters: [14, 17, 18, 6]},
		{id: '1macc', chapters: [
			67, 70, 60, 61, 68, 63, 50, 32, 73, 89, 74, 54, 54, 49,
			41, 24
		]},
		{id: '2macc', chapters: [
			36, 33, 40, 50, 27, 31, 42, 36, 29, 38, 38, 46, 26, 46,
			40
		]}
	],
	nt: [
		...
		{id: 'matt', chapters: [
			25, 23, 17, 25, 48, 34, 29, 34, 38, 42, 30, 50, 58, 36, 39,
			28, 26, 35, 30, 34, 46, 46, 39, 51, 46, 75, 66, 20
		]},
		{id: 'mark', chapters: [
			45, 28, 35, 40, 43, 56, 37, 39, 49, 52, 33, 44, 37, 72, 47,
			20
		]},
		{id: 'luke', chapters: [
			80, 52, 38, 44, 39, 49, 50, 56, 62, 42, 54, 59, 35, 35, 32,
		...
		{id: 'john', chapters: [
			51, 25, 36, 54, 47, 72, 53, 59, 41, 42, 57, 50, 38, 31, 27,
			33, 26, 40, 42, 31, 25
		]},
		{id: 'acts', chapters: [
			26, 47, 26, 37, 42, 15, 59, 40, 43, 48, 30, 25, 52, 27, 41,
		...
		{id: '1john', chapters: [10, 29, 24, 21, 21]},
		{id: '2john', chapters: [13]},
		{id: '3john', chapters: [15]},
		{id: 'jude', chapters: [25]},
		{id: 'rev', chapters: [
			20, 29, 22, 11, 14, 17, 17, 13, 21, 11, 19, 18, 18, 20, 8,
			21, 18, 24, 21, 15, 27, 21
		]},
		{id: 'prman', chapters: [15]},
		{id: '1esd', chapters: [58, 31, 24, 63, 73, 34, 15, 97, 56]},
		{id: '2esd', chapters: [
			40, 48, 36, 52, 56, 59, 140, 63, 47, 60, 46, 51, 58, 48,
			63, 78
		]},
		{id: 'addps', chapters: [7]},
		{id: 'eplao', chapters: [20]}
	]
};

function getBooksBySwordGroup (group, lang, versification) {
	return VERSIFICATION_SCHEMES[versification][group].map(function (book) {
		var data = bibleData.getBookById(book.id, lang);
		data.chapters = book.chapters;
		return data;
	});
}

bibleData.versificationExists = function (scheme) {
	return !!VERSIFICATION_SCHEMES[scheme];
};

bibleData.getBooksBySwordGroup = getBooksBySwordGroup;
